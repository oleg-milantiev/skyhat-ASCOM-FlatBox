...
//
// ASCOM CoverCalibrator driver for SkyHatFlatBox
//
...
namespace ASCOM.SkyHatFlatBox.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.SkyHatFlatBox.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.SkyHatFlatBox.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _SkyHatFlatBox from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("b6071c90-6e72-469f-924d-d9a8fabeb2fe")]
    [ProgId("ASCOM.SkyHatFlatBox.CoverCalibrator")]
    [ServedClassName("SkyHat FlatBox")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SkyHatFlatBox"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "SkyHatFlatBox.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
